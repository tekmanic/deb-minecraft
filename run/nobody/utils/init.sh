...
cat << "EOF"
! __       __ __ __     __ _____ _____ _______ _________ _____ ______
!|  |_   _|  |  |  |_  |  |   __|   __|   _   |  _   _  |   __|_    _|
!|    |_|    |  |    |_|  |  |  |  |  |  |_|  | |_|_|_| |  |__  |  |
!|   _   _   |  |   _     |  |_ |  |  |   _  _|  _| |_  |   __| |  |
!|  | |_| |  |  |  | |_   |   _||  |  |  | ||_| |__|__| |  |    |  |
!|  |     |  |  |  |   |  |  |__|  |__|  | |  |    _    |  |    |  |
!|__|     |__|__|__|   |__|_____|_____|__| |__|___| |___|__|    |__|
Logo by @XentorDoesMinecraft || Scripts by @tekmanic forked from @binhex
EOF
